...
{!! Form::open(['route' => 'roombook.store','files' => true]) !!}
...
{!! Form::label('room_number', 'Confirm Room Number'); !!}
{{ Form::text('room_number', null, array('class' => 'form-control', 'required' => '', 'minlength' => '1') ) }}
